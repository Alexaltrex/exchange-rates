...
const SET_LEFT_CURRENCY = 'converter/SET-LEFT-CURRENCY';
const SET_LEFT_CURRENCY_ADD = 'converter/SET-LEFT-CURRENCY-ADD';
const TOGGLE_LEFT_MODAL = 'converter/TOGGLE-LEFT-MODAL';
const SET_RIGHT_CURRENCY = 'converter/SET-RIGHT-CURRENCY';
const SET_RIGHT_CURRENCY_ADD = 'converter/SET-RIGHT-CURRENCY-ADD';
const TOGGLE_RIGHT_MODAL = 'converter/TOGGLE-RIGHT-MODAL';
const LEFT_INPUT_CHANGE = 'converter/LEFT-INPUT-CHANGE';
const LEFT_INPUT_ADD_SYMBOL = 'converter/RIGHT-INPUT-ADD-SYMBOL';
const RIGHT_INPUT_CHANGE = 'converter/RIGHT-INPUT-CHANGE';
const RIGHT_INPUT_ADD_SYMBOL = 'converter/LEFT-INPUT-ADD-SYMBOL';
const SET_RATE = 'converter/SET-RATE';
const SET_RIGHT_INPUT = 'converter/SET-RIGHT-INPUT';
